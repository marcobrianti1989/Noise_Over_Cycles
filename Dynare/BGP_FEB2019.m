...
erase_compiled_function('BGP_FEB2019_static');
erase_compiled_function('BGP_FEB2019_dynamic');
M_.orig_eq_nbr = 6;
M_.eq_nbr = 6;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state( 5 ) = logthetss;
oo_.steady_state( 6 ) = logzetass;
oo_.steady_state( 3 ) = ess;
oo_.steady_state( 2 ) = rpss;
oo_.steady_state( 4 ) = xss;
...
if exist('bayestopt_', 'var') == 1
  save('BGP_FEB2019_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('BGP_FEB2019_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('BGP_FEB2019_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('BGP_FEB2019_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('BGP_FEB2019_results.mat', 'oo_recursive_', '-append');
end
