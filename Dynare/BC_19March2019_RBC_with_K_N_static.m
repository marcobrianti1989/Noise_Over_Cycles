function [residual, g1, g2, g3] = BC_19March2019_RBC_with_K_N_static(y, x, params)
%
...
if nargout >= 2,
  ...
  g1(3,3)=(-(T37*getPowerDeriv(y(3),1-params(4),1)));
  g1(3,5)=1;
  g1(3,6)=(-(T39*params(4)*T36));
  g1(4,2)=(-(T46*y(6)*(1-params(4))*1/(1+params(6))*getPowerDeriv(T34,params(4),1)));
  g1(4,3)=(-(T44*getPowerDeriv(y(3),(-params(4)),1)));
  g1(4,4)=1;
  g1(4,6)=(-(T46*(1-params(4))*T43));
  g1(5,1)=1;
  g1(5,2)=1-(1-params(2))*1/(1+params(6));
