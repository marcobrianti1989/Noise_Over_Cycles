...
options_ = [];
M_.fname = 'Beaudry_Portier_2004_habit_consumption';
...
diary off;
diary('Beaudry_Portier_2004_habit_consumption.log');
M_.exo_names = 'eps_X';
...
M_.param_names = char(M_.param_names, 'gamL');
M_.param_names_tex = char(M_.param_names_tex, 'gamL');
M_.param_names_long = char(M_.param_names_long, 'gamL');
...
M_.param_names = char(M_.param_names, 'sigL');
M_.param_names_tex = char(M_.param_names_tex, 'sigL');
M_.param_names_long = char(M_.param_names_long, 'sigL');
...
erase_compiled_function('Beaudry_Portier_2004_habit_consumption_static');
erase_compiled_function('Beaudry_Portier_2004_habit_consumption_dynamic');
M_.orig_eq_nbr = 10;
M_.eq_nbr = 10;
M_.ramsey_eq_nbr = 0;
...
options_.irf = 24;
options_.order = 1;
var_list_ = char('LOGSENT','LOGTHETX','C','I','L','X','LK','LX','K');
info = stoch_simul(var_list_);
save('Beaudry_Portier_2004_habit_consumption_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Beaudry_Portier_2004_habit_consumption_results.mat', 'oo_recursive_', '-append');
end
