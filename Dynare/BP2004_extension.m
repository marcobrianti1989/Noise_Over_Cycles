...
erase_compiled_function('BP2004_extension_static');
erase_compiled_function('BP2004_extension_dynamic');
M_.orig_eq_nbr = 13;
M_.eq_nbr = 13;
M_.ramsey_eq_nbr = 0;
...
LXss       = 0.5;
LKss       = 0.1;
Xss        = thetx * LXss^(alp+extX);
Kss        = 0.5;
Lss        = LKss + LXss;
Iss        = thetk * LKss^gam; 
Kss        = 1/del * thetk * LKss^gam - tau/2*Kss*(Iss/Kss-del)^2;
...
oo_.steady_state( 11 ) = LOGTHETXss;
oo_.steady_state( 12 ) = LOGTHETKss;
oo_.steady_state( 13 ) = LOGSENTss;
...
save('BP2004_extension_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('BP2004_extension_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('BP2004_extension_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('BP2004_extension_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('BP2004_extension_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('BP2004_extension_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('BP2004_extension_results.mat', 'oo_recursive_', '-append');
end
