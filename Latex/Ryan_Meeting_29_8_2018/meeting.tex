...
\frame{\frametitle{Objective of the Project}
	...
	\begin{enumerate}
		...
		\item Counterintuitively, inflation tends to decrease with some lags (6-8 quarters).
...
\frame{\frametitle{Local Projection - Confidence Interval 68\% and 90\%}
	...
	\begin{center}
		\includegraphics[scale = 0.27]{\ourFigPath Figures/Unconditional_RyanPresentation_8_28_2018_loglevels_robucheck2}
	\end{center}
