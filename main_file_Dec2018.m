...
[sdensity, period] = spectrum(IRF(1,:));

figure(3);
plot(period(10:200)',sdensity(10:200),'Color','b','LineWidth',3); hold on; %step dependent 
...
ltrough_lower = 50;
ltrough_upper = 70;
D1 = mean(sdensity(find(period>lpeak_upper,1,'last'):find(period>lpeak_lower,1,'last')));
D2 = mean(sdensity(find(period>ltrough_upper,1,'last'):find(period>ltrough_lower,1,'last')));
D  = D1/D2;
