...
T62 = params(7)*exp(y(20))*((y(10)-y(6))/params(6))^(params(7)-1)/params(4);
...
T123 = getPowerDeriv(y(4)-y(1),params(7),1);
T135 = getPowerDeriv((y(10)-y(6))/params(6),params(7)-1,1);
T141 = (y(7)+params(3)-y(19)/params(4))*(y(7)+params(3)-y(19)/params(4));
  g1(1,1)=(-(params(2)*(1-params(1))+T17*(y(7)+params(5)*exp(y(9))+params(3)*params(2))));
  g1(1,6)=1;
  g1(1,7)=(-(((y(7)+params(5)*exp(y(9))+params(3)*params(2))*y(1)-params(4)*y(2))*(-params(1))/T141+T17*y(1)));
  g1(1,19)=(-(((y(7)+params(5)*exp(y(9))+params(3)*params(2))*y(1)-params(4)*y(2))*(-(params(1)*(-(1/params(4)))))/T141));
  g1(1,2)=(-(T17*(-params(4))));
  ...
  g1(3,6)=params(7)*exp(y(20))*(-1)/params(6)*T135/params(4);
  g1(3,7)=(-1);
  g1(3,19)=1/params(4);
  g1(3,20)=T62;
  g1(3,10)=params(7)*exp(y(20))*T135*1/params(6)/params(4);
  g1(4,10)=1;
  g1(5,1)=(-(T69*(-T123)));
  g1(5,9)=(-T73);
  g1(5,4)=(-(T69*T123));
