...
[IR_E_W, IR_R_W, IR_L_W] = stlp(RealWage(loc_start+1:loc_end-2),pc(loc_start+1:loc_end-2,1:mpc),Ztilde(1:end-2), ...
        ProbRecession(loc_start:loc_end-1-2),lags,H);

[IR_E_H, IR_R_H, IR_L_H] = stlp(Hours(loc_start+1:loc_end-2),pc(loc_start+1:loc_end-2,1:mpc),Ztilde(1:end-2), ...
        ProbRecession(loc_start:loc_end-1-2),lags,H);
