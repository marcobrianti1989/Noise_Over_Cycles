...
dataset(start+2:end-lagged+2,4) ... dataset(start-2:end-lagged-2,4) ...
     ...
     dataset(start-6:end-lagged-6,4)  ...
      ...
      dataset(start-9:end-lagged-9,4)  ...
      dataset(start-10:end-lagged-10,4)  ...
...
figure(2)
hold on
q = plot([1:H]', IR_E, '-r', 'linewidth', 3);
h = plot([1:H]', IR_R, '--b','linewidth', 3);
plot([1:H]', 0*[1:H]', ':k');
